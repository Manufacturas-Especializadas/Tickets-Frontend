      ...
      html: `
                <div style="text-align: left; max-height: 70vh; overflow-y: auto; padding: 10px;">
                    ...
                    <div style="margin-bottom: 15px;">
                        ...
                        <textarea id="swal-problemDescription" class="swal2-textarea" placeholder="Describe el problema..." style="width: 70%;">${
      ...
      html: `
                <div style="text-align: left; line-height: 1.6; font-size: 14px;">
                    <div style="text-align: left; line-height: 1.6; font-size: 14px;">
                        ...
                        <p><strong>Estatus:</strong> <span style="color: ${
                          row.status === "Resuelto"
                            ? "#28a745"
  ...
  const handleDownloadReport = async () => {
    ...
    try {
      ...
      await Swal.fire({
        ...
        text:
          error.message ||
          "Ocurrio un problema al generar el archiv. Inténtalo de nuevo",
      });
    }
  };
